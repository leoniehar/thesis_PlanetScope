#### Random Forest Biomass Interpolated Script for variant per Explrtr
## Example with comments 
## this is a script including a split (per explrtr)
...
## copy path to clipboard, next line changes from linux to windows
...
#### sort and select data  and create data frame####
...
## create different dataframe for subsets 
SCH <- all[all$explrtr == "SCH",]
HAI <- all[all$explrtr == "HAI",]
ALB <- all[all$explrtr == "ALB",]

## list containing dataframes of different splits
ex = list(ALB, HAI, SCH)
