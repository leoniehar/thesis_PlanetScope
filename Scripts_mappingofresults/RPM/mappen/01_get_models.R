...
list = c(list.files(path=".", pattern="RPM.RData", all.files=TRUE,
                    full.names=TRUE, recursive = TRUE)
         ,list.files(path=".", pattern="RPM.RData", all.files=TRUE,
                     full.names=TRUE, recursive = TRUE)
         ,list.files(path=".", pattern="RPM_interpolated.RData", all.files=TRUE,
                     full.names=TRUE, recursive = TRUE)
         ,list.files(path=".", pattern="RPM.RData", all.files=TRUE,
                     full.names=TRUE, recursive = TRUE)
)
...
print(list)
name = c("RPM_all","RPM_perExplrtr","RPM_perMonth")
